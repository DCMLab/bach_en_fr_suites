...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the *Prélude* of the first English Suite, BWV 806, has the following files:
